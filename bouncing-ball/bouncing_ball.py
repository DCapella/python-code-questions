"""
You drop a ball from a given height. After each bounce, the ball returns to
some fixed proportion of its previous height. If the ball bounces to height
1 or less, we consider it to have stopped bouncing. Return the number of
...
def bouncing_ball(initial, proportion, n = 0):
    ...
    return bouncing_ball(initial, proportion, n)
